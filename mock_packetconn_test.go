...
//
//	mockgen -typed -package quic -self_package github.com/NguyenHien-8/TCQ-Network-Protocol -self_package github.com/NguyenHien-8/TCQ-Network-Protocol -destination mock_packetconn_test.go net PacketConn
//
