<div align="center" style="margin-bottom: 15px;">
  <img src="../assets/go-hole-tcq2.png" width="700" height="auto">
</div>

# HTTP/3

[![Documentation](https://img.shields.io/badge/docs-quic--go.net-red?style=flat)](https://quic-go.net/docs/)
[![PkgGoDev](https://pkg.go.dev/badge/github.com/NguyenHien-8/TCQ-Network-Protocol/http3)](https://pkg.go.dev/github.com/NguyenHien-8/TCQ-Network-Protocol/http3)
