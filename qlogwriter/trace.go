...
import (
	...
	"github.com/NguyenHien-8/TCQ-Network-Protocol/qlogwriter/jsontext"
)
...
// -ldflags="-X github.com/NguyenHien-8/TCQ-Network-Protocol/qlogwriter.quicGoVersion=foobar"
...
func init() {
	...
	for _, d := range info.Deps {
		if d.Path == "github.com/NguyenHien-8/TCQ-Network-Protocol" {
